...
const REQUIRED_FILES = [
  ...
  "kb/13_evidence/reports/FIRST_CLAIM_PROMOTION_REQUESTS_REPORT.md",
  ...
  "kb/13_evidence/reports/FIRST_MANUAL_NOTES_INTAKE_REPORT.md",
  "kb/13_evidence/reports/MANUAL_QUOTE_AUDIT_REPORT.md",
  "kb/13_evidence/reports/FIRST_MANUAL_QUOTE_INTAKE_REPORT.md",
  "kb/13_evidence/reports/FIRST_PROJECT_OVERLAY_INTAKE_REPORT.md",
  "kb/13_evidence/reports/FIRST_PLAYTEST_LOG_INTAKE_REPORT.md",
  "kb/13_evidence/reports/EVIDENCE_COVERAGE_UPDATE_REPORT.md",
  "kb/13_evidence/reports/EVIDENCE_NAVIGATION_UPDATE_REPORT.md",
...
function validateMarkdownEntities() {
  for (const [relativeDir, inferredType] of ENTITY_DIRS) {
    ...
    for (const filePath of walk(dir).filter((file) => [".md", ".yaml", ".yml"].includes(path.extname(file).toLowerCase()))) {
      ...
      if (isEvidenceDir && (lowerName.includes("template") || lowerName.includes("example") || lowerName.includes("guide") || lowerName.includes("index") || lowerName.includes("backlog") || lowerName.includes("sidecar_audit_report") || lowerName.includes("first_manual_notes_intake_report") || lowerName.includes("first_manual_quote_intake_report") || lowerName.includes("first_claim_promotion_requests_report") || lowerName.includes("first_project_overlay_intake_report") || lowerName.includes("first_playtest_log_intake_report") || lowerName.includes("manual_note_intake_report") || lowerName.includes("manual_quote_audit_report") || lowerName.includes("claim_promotion_audit") || lowerName.includes("game_feel_evidence_pilot") || lowerName.includes("game_feel_evidence_gap_report") || lowerName.includes("game_feel_entity_audit") || lowerName.includes("meaningful_decisions_evidence_pilot") || lowerName.includes("rules_mechanics_evidence_gap_report") || lowerName.includes("meaningful_decisions_entity_audit") || lowerName.includes("systems_economy_playtest_evidence_pilot") || lowerName.includes("project_overlay_evidence_gap_report") || lowerName.includes("playtest_log_evidence_gap_report") || lowerName.includes("systems_economy_entity_audit") || lowerName.includes("evidence_navigation_report") || lowerName.includes("evidence_coverage_update_report") || lowerName.includes("evidence_navigation_update_report") || lowerName.includes("evidence_search_export_report") || lowerName.includes("evidence_portal_audit") || lowerName.includes("phase_2_readiness_report") || lowerName.includes("user_evidence_dependency_report"))) {
        continue;
      }

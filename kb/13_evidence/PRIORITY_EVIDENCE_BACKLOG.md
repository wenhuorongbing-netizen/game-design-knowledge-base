...
| P0 | First project overlay packet | One real project context packet using `FIRST_PROJECT_OVERLAY_REQUEST.md` | Required before project-local coverage can become real evidence. | `derived_from_user_note`, `user_manual_note` |
| P0 | First playtest log packet | One real playtest packet using `FIRST_PLAYTEST_LOG_REQUEST.md` | Required before playtest-local coverage can become real evidence. | `derived_from_user_note`, `user_manual_note` |

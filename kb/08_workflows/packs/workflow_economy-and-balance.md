...
related_cards: ["concept_economy", "concept_source", "concept_sink", "concept_faucet", "concept_drain", "concept_balance", "concept_progression-curve"]
related_lenses: ["lens_systems-and-economy_source-sink-balance", "lens_systems-and-economy_balance-resilience", "lens_systems-and-economy_economy-readability", "lens_systems-and-economy_power-curve"]
related_lessons: ["lesson_04_systems_economy_05_progression-and-power-curves", "lesson_04_systems_economy_06_economy-sources-and-sinks", "lesson_04_systems_economy_01_games-as-systems", "lesson_04_systems_economy_02_parts-loops-and-wholes", "lesson_04_systems_economy_03_game-plus-player-system"]
output_artifacts: ["Economy and Balance worksheet", "design decision log entry", "missing evidence list", "next experiment or playtest question", "project overlay update"]
...
AI_prompt_templates: ["prompt_run-design-audit", "prompt_run-balance-audit", "prompt_produce-design-decision-log", "prompt_update-project-overlay"]
...
forum_thread_template: "Thread title: Economy and Balance Pack review for [artifact]. Include context, intended player experience, workflow output, missing evidence, and one question for reviewers."
project_overlay_update: "Append the Economy and Balance Pack output to the project overlay with changed decisions, evidence gaps, and next experiments."
...
---
# Economy and Balance Pack

## Purpose

Designs sources, sinks, currencies, progression, and balance risks.
...
- lesson_04_systems_economy_05_progression-and-power-curves
- lesson_04_systems_economy_06_economy-sources-and-sinks
- lesson_04_systems_economy_01_games-as-systems
- lesson_04_systems_economy_02_parts-loops-and-wholes
- lesson_04_systems_economy_03_game-plus-player-system
...
Thread title: Economy and Balance Pack review for [artifact]. Include context, intended player experience, workflow output, missing evidence, and one question for reviewers.

## Project Overlay Update

Append the Economy and Balance Pack output to the project overlay with changed decisions, evidence gaps, and next experiments.

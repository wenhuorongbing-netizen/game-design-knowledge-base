...
related_cards: ["concept_skill", "concept_twitch-skill", "concept_strategic-skill", "concept_chance", "concept_challenge", "concept_uncertainty"]
related_lenses: ["lens_mechanics-and-rules_skill-chance-mix", "lens_player-experience_challenge", "lens_player-experience_uncertainty", "lens_mechanics-and-rules_core-loop"]
related_lessons: ["lesson_01_foundations_06_challenge-skill-chance-and-uncertainty", "lesson_03_mechanics_rules_formal_systems_06_strategic-skill", "lesson_03_mechanics_rules_formal_systems_07_twitch-skill", "lesson_02_play_player_experience_04_flow-and-challenge-curves", "lesson_03_mechanics_rules_formal_systems_08_chance-and-probability"]
output_artifacts: ["Skill / Chance / Challenge worksheet", "design decision log entry", "missing evidence list", "next experiment or playtest question", "project overlay update"]
...
forum_thread_template: "Thread title: Skill / Chance / Challenge Pack review for [artifact]. Include context, intended player experience, workflow output, missing evidence, and one question for reviewers."
project_overlay_update: "Append the Skill / Chance / Challenge Pack output to the project overlay with changed decisions, evidence gaps, and next experiments."
...
---
# Skill / Chance / Challenge Pack

## Purpose

Tunes skill, randomness, risk, and difficulty.
...
- lens_player-experience_uncertainty
- lens_mechanics-and-rules_core-loop

## Related Lessons

- lesson_01_foundations_06_challenge-skill-chance-and-uncertainty
- lesson_03_mechanics_rules_formal_systems_06_strategic-skill
- lesson_03_mechanics_rules_formal_systems_07_twitch-skill
- lesson_02_play_player_experience_04_flow-and-challenge-curves
- lesson_03_mechanics_rules_formal_systems_08_chance-and-probability

## Output Artifacts

- Skill / Chance / Challenge worksheet
...
Thread title: Skill / Chance / Challenge Pack review for [artifact]. Include context, intended player experience, workflow output, missing evidence, and one question for reviewers.

## Project Overlay Update

Append the Skill / Chance / Challenge Pack output to the project overlay with changed decisions, evidence gaps, and next experiments.

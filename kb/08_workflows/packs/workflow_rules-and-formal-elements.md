...
related_cards: ["concept_formal-elements", "concept_objectives", "concept_procedures", "concept_rules", "concept_resources", "concept_conflict", "concept_boundaries", "concept_outcome"]
related_lenses: ["lens_mechanics-and-rules_depth-versus-complexity", "lens_mechanics-and-rules_rule-clarity", "lens_play-theory_rules-as-constraints", "lens_mechanics-and-rules_core-loop"]
related_lessons: ["lesson_03_mechanics_rules_formal_systems_03_resources-conflict-boundaries-and-outcomes", "lesson_03_mechanics_rules_formal_systems_01_formal-elements", "lesson_03_mechanics_rules_formal_systems_02_objectives-and-procedures", "lesson_01_foundations_01_what-a-game-designer-actually-decides", "lesson_01_foundations_02_player-centric-design"]
output_artifacts: ["Rules and Formal Elements worksheet", "design decision log entry", "missing evidence list", "next experiment or playtest question", "project overlay update"]
...
forum_thread_template: "Thread title: Rules and Formal Elements Pack review for [artifact]. Include context, intended player experience, workflow output, missing evidence, and one question for reviewers."
project_overlay_update: "Append the Rules and Formal Elements Pack output to the project overlay with changed decisions, evidence gaps, and next experiments."
...
---
# Rules and Formal Elements Pack

## Purpose

Turns gameplay into formal elements: players, objectives, procedures, rules, resources, conflict, boundaries, outcome.
...
- lesson_03_mechanics_rules_formal_systems_03_resources-conflict-boundaries-and-outcomes
- lesson_03_mechanics_rules_formal_systems_01_formal-elements
- lesson_03_mechanics_rules_formal_systems_02_objectives-and-procedures
- lesson_01_foundations_01_what-a-game-designer-actually-decides
- lesson_01_foundations_02_player-centric-design

## Output Artifacts

- Rules and Formal Elements worksheet
...
Thread title: Rules and Formal Elements Pack review for [artifact]. Include context, intended player experience, workflow output, missing evidence, and one question for reviewers.

## Project Overlay Update

Append the Rules and Formal Elements Pack output to the project overlay with changed decisions, evidence gaps, and next experiments.

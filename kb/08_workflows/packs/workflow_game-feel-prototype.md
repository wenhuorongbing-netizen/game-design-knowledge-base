...
domains: ["game_feel", "ui_ux_feedback"]
difficulty: "advanced"
...
related_cards: ["concept_game-feel", "concept_input-metric", "concept_response-metric", "concept_context-metric", "concept_polish-metric", "concept_responsiveness"]
related_lenses: ["lens_game-feel_real-time-control", "lens_game-feel_tight-versus-floaty", "lens_game-feel_input-responsiveness", "lens_game-feel_response-clarity"]
related_lessons: ["lesson_05_game_feel_interaction_05_input-metrics", "lesson_05_game_feel_interaction_06_response-metrics", "lesson_05_game_feel_interaction_07_context-metrics", "lesson_05_game_feel_interaction_08_polish-metrics", "lesson_05_game_feel_interaction_04_polish-and-perceptual-conviction"]
output_artifacts: ["Game Feel Prototype worksheet", "design decision log entry", "missing evidence list", "next experiment or playtest question", "project overlay update"]
...
forum_thread_template: "Thread title: Game Feel Prototype Pack review for [artifact]. Include context, intended player experience, workflow output, missing evidence, and one question for reviewers."
project_overlay_update: "Append the Game Feel Prototype Pack output to the project overlay with changed decisions, evidence gaps, and next experiments."
...
---
# Game Feel Prototype Pack

## Purpose

Designs input, response, context, polish, and tuning experiments.
...
- lesson_05_game_feel_interaction_05_input-metrics
- lesson_05_game_feel_interaction_06_response-metrics
- lesson_05_game_feel_interaction_07_context-metrics
- lesson_05_game_feel_interaction_08_polish-metrics
- lesson_05_game_feel_interaction_04_polish-and-perceptual-conviction

## Output Artifacts

- Game Feel Prototype worksheet
...
Thread title: Game Feel Prototype Pack review for [artifact]. Include context, intended player experience, workflow output, missing evidence, and one question for reviewers.

## Project Overlay Update

Append the Game Feel Prototype Pack output to the project overlay with changed decisions, evidence gaps, and next experiments.

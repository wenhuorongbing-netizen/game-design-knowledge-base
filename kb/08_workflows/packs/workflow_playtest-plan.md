...
domains: ["playtesting", "player_experience"]
...
related_cards: ["concept_playtest", "concept_audience", "concept_feedback", "concept_problem-statement"]
related_lenses: ["lens_prototype-and-playtest_observation-quality", "lens_prototype-and-playtest_survey-usefulness", "lens_prototype-and-playtest_playtest-signal", "lens_prototype-and-playtest_iteration-decision"]
related_lessons: ["lesson_06_ui_ux_feedback_08_ui-playtest-methods", "lesson_08_prototyping_playtesting_iteration_06_playtest-planning", "lesson_08_prototyping_playtesting_iteration_08_interpreting-feedback", "lesson_08_prototyping_playtesting_iteration_01_experience-goals", "lesson_08_prototyping_playtesting_iteration_02_prototype-questions"]
output_artifacts: ["Playtest Plan worksheet", "design decision log entry", "missing evidence list", "next experiment or playtest question", "project overlay update"]
...
forum_thread_template: "Thread title: Playtest Plan Pack review for [artifact]. Include context, intended player experience, workflow output, missing evidence, and one question for reviewers."
project_overlay_update: "Append the Playtest Plan Pack output to the project overlay with changed decisions, evidence gaps, and next experiments."
...
Defines who, where, what, how, data, observation, and interview.
...
- lens_prototype-and-playtest_playtest-signal
- lens_prototype-and-playtest_iteration-decision

## Related Lessons

- lesson_06_ui_ux_feedback_08_ui-playtest-methods
- lesson_08_prototyping_playtesting_iteration_06_playtest-planning
- lesson_08_prototyping_playtesting_iteration_08_interpreting-feedback
...
Thread title: Playtest Plan Pack review for [artifact]. Include context, intended player experience, workflow output, missing evidence, and one question for reviewers.

## Project Overlay Update

Append the Playtest Plan Pack output to the project overlay with changed decisions, evidence gaps, and next experiments.

...
domains: ["prototyping", "production_process", "game_feel"]
...
related_cards: ["concept_digital-prototype", "concept_prototype", "concept_iteration", "concept_game-feel"]
related_lenses: ["lens_prototype-and-playtest_learning-speed", "lens_game-feel_input-responsiveness", "lens_prototype-and-playtest_prototype-question", "lens_prototype-and-playtest_disposable-prototype"]
related_lessons: ["lesson_05_game_feel_interaction_10_game-feel-prototype-lab", "lesson_08_prototyping_playtesting_iteration_04_digital-prototypes", "lesson_08_prototyping_playtesting_iteration_02_prototype-questions", "lesson_08_prototyping_playtesting_iteration_03_paper-prototypes", "lesson_08_prototyping_playtesting_iteration_05_kinesthetic-prototypes"]
output_artifacts: ["Digital Prototype worksheet", "design decision log entry", "missing evidence list", "next experiment or playtest question", "project overlay update"]
...
AI_prompt_templates: ["prompt_run-design-audit", "prompt_run-game-feel-audit", "prompt_produce-design-decision-log", "prompt_update-project-overlay"]
...
forum_thread_template: "Thread title: Digital Prototype Pack review for [artifact]. Include context, intended player experience, workflow output, missing evidence, and one question for reviewers."
project_overlay_update: "Append the Digital Prototype Pack output to the project overlay with changed decisions, evidence gaps, and next experiments."
...
---
# Digital Prototype Pack

## Purpose

Plans rapid digital implementation.
...
- lesson_05_game_feel_interaction_10_game-feel-prototype-lab
...
Thread title: Digital Prototype Pack review for [artifact]. Include context, intended player experience, workflow output, missing evidence, and one question for reviewers.

## Project Overlay Update

Append the Digital Prototype Pack output to the project overlay with changed decisions, evidence gaps, and next experiments.

...
domains: ["prototyping", "rules_and_mechanics"]
difficulty: "beginner"
...
related_cards: ["concept_paper-prototype", "concept_rules", "concept_procedures", "concept_resources"]
related_lenses: ["lens_prototype-and-playtest_disposable-prototype", "lens_prototype-and-playtest_playtest-signal", "lens_mechanics-and-rules_rule-clarity", "lens_prototype-and-playtest_learning-speed"]
related_lessons: ["lesson_08_prototyping_playtesting_iteration_03_paper-prototypes", "lesson_03_mechanics_rules_formal_systems_02_objectives-and-procedures", "lesson_03_mechanics_rules_formal_systems_03_resources-conflict-boundaries-and-outcomes", "lesson_08_prototyping_playtesting_iteration_02_prototype-questions", "lesson_08_prototyping_playtesting_iteration_04_digital-prototypes"]
output_artifacts: ["Paper Prototype worksheet", "design decision log entry", "missing evidence list", "next experiment or playtest question", "project overlay update"]
...
forum_thread_template: "Thread title: Paper Prototype Pack review for [artifact]. Include context, intended player experience, workflow output, missing evidence, and one question for reviewers."
project_overlay_update: "Append the Paper Prototype Pack output to the project overlay with changed decisions, evidence gaps, and next experiments."
...
---
# Paper Prototype Pack

## Purpose

Converts systems into testable non-digital prototypes.
...
Thread title: Paper Prototype Pack review for [artifact]. Include context, intended player experience, workflow output, missing evidence, and one question for reviewers.

## Project Overlay Update

Append the Paper Prototype Pack output to the project overlay with changed decisions, evidence gaps, and next experiments.

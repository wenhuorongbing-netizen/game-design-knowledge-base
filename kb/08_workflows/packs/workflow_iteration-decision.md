...
domains: ["playtesting", "production_process"]
difficulty: "advanced"
...
related_cards: ["concept_iteration", "concept_playtest", "concept_feedback", "concept_design-document"]
related_lenses: ["lens_prototype-and-playtest_iteration-decision", "lens_ai-assisted-design-and-kb-governance_claim-traceability", "lens_ai-assisted-design-and-kb-governance_confidence-calibration", "lens_mechanics-and-rules_meaningful-decisions"]
related_lessons: ["lesson_08_prototyping_playtesting_iteration_09_iteration-decisions", "lesson_08_prototyping_playtesting_iteration_08_interpreting-feedback", "lesson_09_production_team_community_release_01_design-documentation", "lesson_01_foundations_05_meaningful-decisions", "lesson_04_systems_economy_04_feedback-loops"]
output_artifacts: ["Iteration Decision worksheet", "design decision log entry", "missing evidence list", "next experiment or playtest question", "project overlay update"]
...
forum_thread_template: "Thread title: Iteration Decision Pack review for [artifact]. Include context, intended player experience, workflow output, missing evidence, and one question for reviewers."
project_overlay_update: "Append the Iteration Decision Pack output to the project overlay with changed decisions, evidence gaps, and next experiments."
...
---
# Iteration Decision Pack

## Purpose

Turns playtest findings into design changes.
...
- lesson_08_prototyping_playtesting_iteration_09_iteration-decisions
...
Thread title: Iteration Decision Pack review for [artifact]. Include context, intended player experience, workflow output, missing evidence, and one question for reviewers.

## Project Overlay Update

Append the Iteration Decision Pack output to the project overlay with changed decisions, evidence gaps, and next experiments.

...
domains: ["narrative_design", "rules_and_mechanics"]
difficulty: "advanced"
...
related_cards: ["concept_story", "concept_premise", "concept_mechanics", "concept_agency", "concept_emergent-story"]
related_lenses: ["lens_narrative-world-character_story-function", "lens_narrative-world-character_thematic-resonance", "lens_narrative-world-character_narrative-agency", "lens_narrative-world-character_character-function"]
related_lessons: ["lesson_07_narrative_world_character_01_story-versus-game-structure", "lesson_07_narrative_world_character_04_environmental-storytelling", "lesson_01_foundations_01_what-a-game-designer-actually-decides", "lesson_01_foundations_02_player-centric-design", "lesson_01_foundations_03_games-as-experiences"]
output_artifacts: ["Narrative-Mechanic Alignment worksheet", "design decision log entry", "missing evidence list", "next experiment or playtest question", "project overlay update"]
...
forum_thread_template: "Thread title: Narrative-Mechanic Alignment Pack review for [artifact]. Include context, intended player experience, workflow output, missing evidence, and one question for reviewers."
project_overlay_update: "Append the Narrative-Mechanic Alignment Pack output to the project overlay with changed decisions, evidence gaps, and next experiments."
...
---
# Narrative-Mechanic Alignment Pack

## Purpose

Checks whether story and mechanics support each other.
...
- lens_narrative-world-character_thematic-resonance
...
- lesson_07_narrative_world_character_04_environmental-storytelling
- lesson_01_foundations_01_what-a-game-designer-actually-decides
- lesson_01_foundations_02_player-centric-design
- lesson_01_foundations_03_games-as-experiences

## Output Artifacts

- Narrative-Mechanic Alignment worksheet
...
Thread title: Narrative-Mechanic Alignment Pack review for [artifact]. Include context, intended player experience, workflow output, missing evidence, and one question for reviewers.

## Project Overlay Update

Append the Narrative-Mechanic Alignment Pack output to the project overlay with changed decisions, evidence gaps, and next experiments.

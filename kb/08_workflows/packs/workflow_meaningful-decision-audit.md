...
related_cards: ["concept_meaningful-decisions", "concept_tradeoffs", "concept_dilemmas", "concept_agency"]
related_lenses: ["lens_mechanics-and-rules_dilemma-quality", "lens_mechanics-and-rules_meaningful-decisions", "lens_mechanics-and-rules_tradeoffs", "lens_ai-assisted-design-and-kb-governance_reusable-prompt-quality"]
related_lessons: ["lesson_01_foundations_05_meaningful-decisions", "lesson_03_mechanics_rules_formal_systems_05_tradeoffs-and-dilemmas", "lesson_08_prototyping_playtesting_iteration_09_iteration-decisions", "lesson_02_play_player_experience_06_player-agency-and-identity", "lesson_07_narrative_world_character_03_narrative-agency"]
output_artifacts: ["Meaningful Decision Audit worksheet", "design decision log entry", "missing evidence list", "next experiment or playtest question", "project overlay update"]
...
forum_thread_template: "Thread title: Meaningful Decision Audit Pack review for [artifact]. Include context, intended player experience, workflow output, missing evidence, and one question for reviewers."
project_overlay_update: "Append the Meaningful Decision Audit Pack output to the project overlay with changed decisions, evidence gaps, and next experiments."
...
---
# Meaningful Decision Audit Pack

## Purpose

Checks whether choices actually matter.
...
- lens_ai-assisted-design-and-kb-governance_reusable-prompt-quality
...
- lesson_02_play_player_experience_06_player-agency-and-identity
- lesson_07_narrative_world_character_03_narrative-agency

## Output Artifacts

- Meaningful Decision Audit worksheet
...
Thread title: Meaningful Decision Audit Pack review for [artifact]. Include context, intended player experience, workflow output, missing evidence, and one question for reviewers.

## Project Overlay Update

Append the Meaningful Decision Audit Pack output to the project overlay with changed decisions, evidence gaps, and next experiments.

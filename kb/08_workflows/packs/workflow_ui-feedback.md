...
related_cards: ["concept_interface", "concept_feedback", "concept_mental-model", "concept_player-rights"]
related_lenses: ["lens_ui-ux-feedback_information-priority", "lens_ui-ux-feedback_input-mapping", "lens_player-experience_accessibility", "lens_ui-ux-feedback_accessibility"]
related_lessons: ["lesson_06_ui_ux_feedback_01_interface-as-player-contact", "lesson_06_ui_ux_feedback_02_information-priority", "lesson_06_ui_ux_feedback_03_input-mapping", "lesson_06_ui_ux_feedback_04_feedback-timing", "lesson_06_ui_ux_feedback_05_affordance-and-readability"]
output_artifacts: ["UI Feedback worksheet", "design decision log entry", "missing evidence list", "next experiment or playtest question", "project overlay update"]
...
forum_thread_template: "Thread title: UI Feedback Pack review for [artifact]. Include context, intended player experience, workflow output, missing evidence, and one question for reviewers."
project_overlay_update: "Append the UI Feedback Pack output to the project overlay with changed decisions, evidence gaps, and next experiments."
...
Audits information hierarchy, input mapping, feedback, affordance, and accessibility.
...
- lesson_06_ui_ux_feedback_01_interface-as-player-contact
- lesson_06_ui_ux_feedback_02_information-priority
- lesson_06_ui_ux_feedback_03_input-mapping
- lesson_06_ui_ux_feedback_04_feedback-timing
- lesson_06_ui_ux_feedback_05_affordance-and-readability

## Output Artifacts

- UI Feedback worksheet
...
Thread title: UI Feedback Pack review for [artifact]. Include context, intended player experience, workflow output, missing evidence, and one question for reviewers.

## Project Overlay Update

Append the UI Feedback Pack output to the project overlay with changed decisions, evidence gaps, and next experiments.

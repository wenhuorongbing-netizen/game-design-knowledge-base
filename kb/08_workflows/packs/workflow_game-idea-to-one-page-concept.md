...
phase_groups: ["立项与方向"]
domains: ["player_experience", "business_pitch_release"]
difficulty: "beginner"
...
related_cards: ["concept_ideation", "concept_problem-statement", "concept_player-experience", "concept_pitch"]
related_lenses: ["lens_project-direction_core-experience", "lens_player-experience_agency", "lens_player-experience_challenge", "lens_player-experience_curiosity"]
related_lessons: ["lesson_01_foundations_08_the-difference-between-ideas-and-designs", "lesson_01_foundations_01_what-a-game-designer-actually-decides", "lesson_01_foundations_02_player-centric-design", "lesson_01_foundations_03_games-as-experiences", "lesson_01_foundations_04_games-as-systems-of-rules"]
output_artifacts: ["Game Idea to One-Page Concept worksheet", "design decision log entry", "missing evidence list", "next experiment or playtest question", "project overlay update"]
...
forum_thread_template: "Thread title: Game Idea to One-Page Concept Pack review for [artifact]. Include context, intended player experience, workflow output, missing evidence, and one question for reviewers."
project_overlay_update: "Append the Game Idea to One-Page Concept Pack output to the project overlay with changed decisions, evidence gaps, and next experiments."
...
---
# Game Idea to One-Page Concept Pack

## Purpose

Transforms a vague idea into a one-page concept.
...
- lens_player-experience_curiosity

## Related Lessons

- lesson_01_foundations_08_the-difference-between-ideas-and-designs
...
- lesson_01_foundations_04_games-as-systems-of-rules

## Output Artifacts

- Game Idea to One-Page Concept worksheet
...
Thread title: Game Idea to One-Page Concept Pack review for [artifact]. Include context, intended player experience, workflow output, missing evidence, and one question for reviewers.

## Project Overlay Update

Append the Game Idea to One-Page Concept Pack output to the project overlay with changed decisions, evidence gaps, and next experiments.

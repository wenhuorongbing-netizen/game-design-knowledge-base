...
domains: ["prototyping", "playtesting"]
difficulty: "beginner"
...
related_cards: ["concept_prototype", "concept_problem-statement", "concept_experience-goal", "concept_playtest"]
related_lenses: ["lens_prototype-and-playtest_learning-speed", "lens_prototype-and-playtest_prototype-question", "lens_prototype-and-playtest_test-bias", "lens_prototype-and-playtest_disposable-prototype"]
related_lessons: ["lesson_08_prototyping_playtesting_iteration_02_prototype-questions", "lesson_08_prototyping_playtesting_iteration_01_experience-goals", "lesson_08_prototyping_playtesting_iteration_03_paper-prototypes", "lesson_08_prototyping_playtesting_iteration_04_digital-prototypes", "lesson_08_prototyping_playtesting_iteration_05_kinesthetic-prototypes"]
output_artifacts: ["Prototype Question worksheet", "design decision log entry", "missing evidence list", "next experiment or playtest question", "project overlay update"]
...
AI_prompt_templates: ["prompt_run-design-audit", "prompt_generate-playtest-questions", "prompt_produce-design-decision-log", "prompt_update-project-overlay"]
...
forum_thread_template: "Thread title: Prototype Question Pack review for [artifact]. Include context, intended player experience, workflow output, missing evidence, and one question for reviewers."
project_overlay_update: "Append the Prototype Question Pack output to the project overlay with changed decisions, evidence gaps, and next experiments."
...
---
# Prototype Question Pack

## Purpose

Forces every prototype to answer one clear design question.
...
- lens_prototype-and-playtest_prototype-question
- lens_prototype-and-playtest_test-bias
- lens_prototype-and-playtest_disposable-prototype

## Related Lessons

- lesson_08_prototyping_playtesting_iteration_02_prototype-questions
- lesson_08_prototyping_playtesting_iteration_01_experience-goals
- lesson_08_prototyping_playtesting_iteration_03_paper-prototypes
- lesson_08_prototyping_playtesting_iteration_04_digital-prototypes
- lesson_08_prototyping_playtesting_iteration_05_kinesthetic-prototypes

## Output Artifacts

- Prototype Question worksheet
...
- prompt_generate-playtest-questions
...
Thread title: Prototype Question Pack review for [artifact]. Include context, intended player experience, workflow output, missing evidence, and one question for reviewers.

## Project Overlay Update

Append the Prototype Question Pack output to the project overlay with changed decisions, evidence gaps, and next experiments.

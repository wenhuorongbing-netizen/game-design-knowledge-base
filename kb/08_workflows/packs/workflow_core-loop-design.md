...
related_cards: ["concept_loop", "concept_mechanics", "concept_feedback", "concept_resources"]
related_lenses: ["lens_systems-and-economy_parts-loops-whole", "lens_systems-and-economy_feedback-loops", "lens_systems-and-economy_runaway-loops", "lens_mechanics-and-rules_core-loop"]
related_lessons: ["lesson_04_systems_economy_04_feedback-loops", "lesson_04_systems_economy_02_parts-loops-and-wholes", "lesson_03_mechanics_rules_formal_systems_03_resources-conflict-boundaries-and-outcomes", "lesson_01_foundations_01_what-a-game-designer-actually-decides", "lesson_01_foundations_02_player-centric-design"]
output_artifacts: ["Core Loop Design worksheet", "design decision log entry", "missing evidence list", "next experiment or playtest question", "project overlay update"]
...
forum_thread_template: "Thread title: Core Loop Design Pack review for [artifact]. Include context, intended player experience, workflow output, missing evidence, and one question for reviewers."
project_overlay_update: "Append the Core Loop Design Pack output to the project overlay with changed decisions, evidence gaps, and next experiments."
...
---
# Core Loop Design Pack

## Purpose

Defines actions, feedback, rewards, friction, and repetition.
...
Thread title: Core Loop Design Pack review for [artifact]. Include context, intended player experience, workflow output, missing evidence, and one question for reviewers.

## Project Overlay Update

Append the Core Loop Design Pack output to the project overlay with changed decisions, evidence gaps, and next experiments.

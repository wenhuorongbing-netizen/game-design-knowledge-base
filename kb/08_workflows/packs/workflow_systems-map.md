...
domains: ["systems_design", "economy_and_balance"]
difficulty: "advanced"
...
related_cards: ["concept_system", "concept_part", "concept_loop", "concept_whole", "concept_feedback-loop", "concept_emergence"]
related_lenses: ["lens_systems-and-economy_parts-loops-whole", "lens_systems-and-economy_feedback-loops", "lens_mechanics-and-rules_emergent-possibility", "lens_systems-and-economy_runaway-loops"]
related_lessons: ["lesson_04_systems_economy_02_parts-loops-and-wholes", "lesson_04_systems_economy_04_feedback-loops", "lesson_04_systems_economy_08_emergence-and-systemic-risk", "lesson_04_systems_economy_01_games-as-systems", "lesson_04_systems_economy_03_game-plus-player-system"]
output_artifacts: ["Systems Map worksheet", "design decision log entry", "missing evidence list", "next experiment or playtest question", "project overlay update"]
...
forum_thread_template: "Thread title: Systems Map Pack review for [artifact]. Include context, intended player experience, workflow output, missing evidence, and one question for reviewers."
project_overlay_update: "Append the Systems Map Pack output to the project overlay with changed decisions, evidence gaps, and next experiments."
...
Maps parts, loops, wholes, feedback, and emergent risks.
...
Thread title: Systems Map Pack review for [artifact]. Include context, intended player experience, workflow output, missing evidence, and one question for reviewers.

## Project Overlay Update

Append the Systems Map Pack output to the project overlay with changed decisions, evidence gaps, and next experiments.
